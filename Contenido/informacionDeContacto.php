<?php 
	...
	function cargarInformacion($conexion)
	{
		...
		echo '<div class="col-md-12 ui segment">
 ...
 ?>
				...
				<div class="col-md-12 ui segment" style="border-width: 1px 1px 1px 1px; margin-top: 1rem; border-style: solid; border-color: lightgray;">
							<br>
				...
				<?php  
					if (isset($_SESSION["Proveedor"])) {
						echo '<div class="col-md-12 ui segment" style="border-width: 1px 1px 1px 1px; ; margin-top: 1rem; border-style: solid; border-color: lightgray;">
							<br>
							<h4 style="text-align: center;">
